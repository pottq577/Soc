...
def pitch():
    ...
    # Prepare Circles
    centreCircle = Ellipse((50, 50), width=30, height=39,
                           edgecolor="black", facecolor="None", lw=1.8)
    centreSpot = Ellipse((50, 50), width=1, height=1.5,
                         edgecolor="black", facecolor="black", lw=1.8)
    leftPenSpot = Ellipse((11, 50), width=1, height=1.5,
                          edgecolor="black", facecolor="black", lw=1.8)
    rightPenSpot = Ellipse((89, 50), width=1, height=1.5,
                           edgecolor="black", facecolor="black", lw=1.8)
...
def draw_pitch(pitch, line, orientation='h', view='full', alpha=1, size_x=10.4, size_y=6.8):
    ...
    if orientation.lower().startswith("h"):
        ...
        circle1 = plt.Circle((93.5, 34), 9.15, ls='solid',
                             lw=1.5, color=line, fill=False, zorder=0, alpha=1)
        circle2 = plt.Circle((10.5, 34), 9.15, ls='solid',
                             lw=1.5, color=line, fill=False, zorder=0, alpha=1)
        circle3 = plt.Circle((52, 34), 9.15, ls='solid',
                             lw=1.5, color=line, fill=False, zorder=1, alpha=1)

        # rectangles in boxes
        rec1 = plt.Rectangle((87.5, 20), 16, 30, ls='-',
                             color=pitch, zorder=0, alpha=alpha)
        rec2 = plt.Rectangle((0, 20), 16.5, 30, ls='-',
                             color=pitch, zorder=0, alpha=alpha)

        # pitch rectangle
        rec3 = plt.Rectangle((-1, -1), 106, 70, ls='-',
                             color=pitch, zorder=0, alpha=alpha)
        ...
        circle1 = plt.Circle((34, 93.5), 9.15, ls='solid',
                             lw=1.5, color=line, fill=False, zorder=0, alpha=1)
        circle2 = plt.Circle((34, 10.5), 9.15, ls='solid',
                             lw=1.5, color=line, fill=False, zorder=0, alpha=1)
        circle3 = plt.Circle((34, 52), 9.15, ls='solid',
                             lw=1.5, color=line, fill=False, zorder=1, alpha=1)
